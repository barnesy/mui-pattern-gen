...
import { PatternWrapper } from '../components/configuration/PatternWrapper';
import { usePatternProps } from '../contexts/PatternPropsContext';

export interface WithConfigurationWrapperOptions {
  patternName: string;
...
/**
 * Higher-order component that wraps patterns with the Configuration PatternWrapper
 * This enables Configuration Mode detection for the pattern
 */
export function withConfigurationWrapper<P extends Record<string, any>>(
  Component: React.ComponentType<P>,
  options: WithConfigurationWrapperOptions
) {
  ...
  WrappedComponent.displayName = `WithConfigurationWrapper(${Component.displayName || Component.name || 'Component'})`;

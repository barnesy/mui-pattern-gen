  ...
  return (
    <Box sx={{ p: 4 }}>
      ...
      <Typography variant="body2" color="text.secondary" gutterBottom>
        Body has data-ai-mode:{' '}
        <strong>{document.body.getAttribute('data-ai-mode') || 'NOT SET'}</strong>
      </Typography>
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Paper sx={{ p: 2, mb: 2 }} data-subcomponent-id="test-1">
          <Typography>Direct Sub-Component (has data-subcomponent-id)</Typography>
          <Typography variant="caption">
            Should show dashed outline on hover when AI Mode is on
          </Typography>
        </Paper>
        ...
        >
          ...
          <Paper sx={{ p: 2, mt: 1 }} data-subcomponent-id="test-2">

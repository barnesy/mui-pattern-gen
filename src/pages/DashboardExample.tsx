          ...
          <Grid container spacing={{ xs: 2, sm: 2, md: 3 }}>
            <Grid item xs={12} sm={6} md={3}>
              <AIDataDisplayCard
                variant="stats"
                title="Total Users"
                stats={[{ label: 'Active Users', value: '12,345', trend: 'up', change: '+12%' }]}
                showHeader={true}
            ...
            <Grid item xs={12} sm={6} md={3}>
              <AIDataDisplayCard
                ...
                stats={[{ label: 'Conversion', value: '3.45%', trend: 'down', change: '-0.5%' }]}
                showHeader={true}
            ...
            <Grid item xs={12} sm={6} md={3}>
              <AIDataDisplayCard
                ...
                stats={[{ label: 'Open Tickets', value: '89', trend: 'up', change: '+23' }]}
                showHeader={true}
                headerTitle="Support"
                elevation={0}
                padding={{
                ...
                listItems={[
                  {
                    ...
                    secondary: isMobile
                      ...
                      : 'john.doe@example.com joined 5 minutes ago',
                    timestamp: '5m ago',
                  },
                  {
                    id: '2',
                    ...
                    secondary: isMobile
                      ? 'Order #12345'
                      : 'Order #12345 was successfully processed',
                    timestamp: '12m ago',
                  },
                  {
                    id: '3',

...
import { PatternUpdateTest } from './pages/PatternUpdateTest';
import { AIDesignValidation } from './pages/AIDesignValidation';
      ...
      <BrowserRouter>
        <Routes>
          ...
          >
            ...
            <Route path="pattern-update-test" element={<PatternUpdateTest />} />
            <Route path="ai-validation" element={<AIDesignValidation />} />
          </Route>
        </Routes>
      </BrowserRouter>
